...
public:
    ...
    static Eigen::Vector6d plk_to_pose( Eigen::Vector6d plk_w, Eigen::Matrix3d Rcw, Eigen::Vector3d tcw );
    static Eigen::Vector6d plk_from_pose( Eigen::Vector6d plk_c, Eigen::Matrix3d Rcw, Eigen::Vector3d tcw ); 
    static void cvtOrthonormalToPlucker(double *orth, Eigen::Vector3d &n, Eigen::Vector3d &d);
    static void cvtOrthonormalToPlucker(const std::vector<double>& orth, Eigen::Vector3d &n, Eigen::Vector3d &d);
    static Eigen::Vector6d pipi_plk( Eigen::Vector4d pi1, Eigen::Vector4d pi2);
